...
export class AuthService {
  ...
  logout(){
    ...
    estaLogado(): boolean{
      return !!localStorage.getItem(this.CHAVE_AUTH); //verifica se existe a chave auth no localstorage "estaLogado"
     }
     //pegar a chave de autenticação do usuário, pegar as informações
    usuarioAtual(): any{
